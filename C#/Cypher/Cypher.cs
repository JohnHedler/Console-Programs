    ...
    class Cypher
    {
        ...
        static void WriteFile()
        {
            ...
            try
            {
                ...
                Console.Write("\nPlease enter file name to be created: ");
                ...
                if (!File.Exists(fileName + ".txt"))
                {
                    ...
                    //display to the user that the file has been created
                    Console.WriteLine($"\nFile '{fileName}.txt' has been successfully created and saved.");
                }
                else
                {
                    //ask user for input
                    ...
                    //display to the user that the file has been updated and saved.
                    Console.WriteLine($"\nFile '{fileName}.txt' has been updated and saved.");
                }
            }catch
            {
        ...
        static void ReadFile()
        {
            ...
            try
            {
                ...
                Console.Write("Please enter the file name to be read: ");
                fileName = Console.ReadLine();
