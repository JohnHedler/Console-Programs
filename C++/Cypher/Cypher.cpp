...
void writeFile() {
    ...
    std::cout << "Please enter a file name to be created: ";
    std::cin >> fileName;
    std::cin.ignore();
    fileName += ".txt";
    ...
    std::cout << std::endl << fileName << " has been successfully created and saved." << std::endl;
}
...
void readFile() {
    ...
    //ask user for file name to be created
    std::cout << "Please enter a file name to be read: ";
    std::cin >> fileName;
    std::cin.ignore();
    fileName += ".txt";
